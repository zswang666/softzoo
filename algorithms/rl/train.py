...
from .utils import import_envs, import_policies  # noqa: F401 pytype: disable=import-error
...
if __name__ == "__main__":  # noqa: C901
    ...
    parser.add_argument("-f", "--log-folder", help="Log folder", type=str, default="local/rl")
    parser.add_argument("--seed", help="Random generator seed", type=int, default=-1)
    parser.add_argument("--vec-env", help="VecEnv type", type=str, default="subproc", choices=["dummy", "subproc"]) # NOTE: individual process for taichi
    parser.add_argument("--device", help="PyTorch device to be use (ex: cpu, cuda...)", default="cpu", type=str) # NOTE: default to cpu to avoid conflict between torch-gpu and taichi-gpu
    parser.add_argument(
        "--n-trials",
