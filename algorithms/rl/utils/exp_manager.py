...
from . import import_envs  # noqa: F401 pytype: disable=import-error
...
class ExperimentManager:
    ...
    def __init__(
        ...
        self.yaml_file = yaml_file or os.path.join(os.path.dirname(__file__), f"../hyperparams/{self.algo}.yml")
